...
def _beat_schedule() -> dict[str, dict[str, object]]:
    ...
    return {
        ...
        # Drains the MusicBrainz enrichment backlog. Runs at 04:30 ET,
        # right after the 04:00 scraper pass so any newly-ingested
        # artists pick up genre tags before the Spotify enrichment job
        # at 05:30 makes its own pass.
        "backfill-musicbrainz-enrichment-nightly": {
            "task": (
