...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("SUCCESS", "PARTIAL", "FAILED", name="scraper_run_status"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_scraper_runs_venue_slug"), "scraper_runs", ["venue_slug"], unique=False
    )
    op.create_table(
        "users",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "digest_frequency",
            sa.Enum("DAILY", "WEEKLY", "NEVER", name="digest_frequency"),
            nullable=False,
        ),
        sa.Column(
            "genre_preferences", postgresql.ARRAY(sa.String(length=50)), nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_email_digest_log_user_id"),
        "email_digest_log",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "event_type",
            sa.Enum(
                "CONCERT", "COMEDY", "THEATER", "SPORTS", "OTHER", name="event_type"
            ),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            "spotify_artist_ids", postgresql.ARRAY(sa.String(length=50)), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.Enum("SPOTIFY", "GOOGLE", "APPLE", name="oauth_provider"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_user_oauth_providers_provider_user_id"),
        "user_oauth_providers",
        ["provider_user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "score_breakdown", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_recommendations_event_id"),
        "recommendations",
        ["event_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_saved_events_event_id"), "saved_events", ["event_id"], unique=False
    )
    op.create_index(
        op.f("ix_saved_events_user_id"), "saved_events", ["user_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_ticket_pricing_snapshots_event_id"),
        "ticket_pricing_snapshots",
        ["event_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_events_spotify_artist_ids_gin", table_name="events", postgresql_using="gin"
    )
